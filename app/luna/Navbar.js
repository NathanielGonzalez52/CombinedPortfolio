    ...
    <>
        <nav className="nav-head">
            ...
            <ul id="navbar" className={click ? 'navbar active' : 'navbar'}>
                <li><Link href="/luna" className={checkActivePath("/") ? 'active' : ''}>
                Home
                </Link></li>
                <li><Link href="/luna/sale" className={checkActivePath("/sale") ? 'active' : ''}>
                Shop
                </Link></li>
                <li><Link href="/luna/lunaabout" className={checkActivePath("/about") ? 'active' : ''}>
                About
                </Link></li>
            </ul>
            </div>
